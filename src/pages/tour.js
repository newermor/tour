...
const cardList = [
  {
    ...
    money: "$ 200-300",
    url: "https://avatars.mds.yandex.net/i?id=265b17b4d734d85d1bc4b1d4b423ba0f_l-5354769-images-thumbs&ref=rim&n=13&w=1080&h=1350",
    day: "02-05-2022",
    number: "4.5",
    Series: "Tour muddati",
  },
  {
    ...
    money: "$290.50",
    url: "https://adolatgzt.uz/userfiles/333/images/Amir%20temur-1000405.jpg",
    day: "2022-12-05",
    number: "7.5",
    Series: "Series",
  },
            ...
            <div key={e.id} class="py-3 sm:max-w-xl sm:mx-auto  m-12">
              <div class="bg-white shadow-lg border-gray-100 max-h-80	 border sm:rounded-3xl p-8 flex space-x-8">
                <div class="h-48 overflow-visible w-1/2">
                  <img
                    class="rounded-3xl shadow-lg object-contain object-center "
                    src={e.url}
                    alt=""
                  />
                </div>
